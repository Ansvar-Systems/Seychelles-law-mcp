...
This document addresses privacy and confidentiality considerations when using this Tool, with particular attention to professional obligations under Seychelles legal professional rules.
...
- Law Society of Seychelles rules require strict confidentiality and data handling controls

**Safe Use Options:**
1. **General Legal Research**: Use Tool for non-client-specific queries
2. **Local npm Package**: Install `@ansvar/seychelles-law-mcp` locally — database queries stay on your machine
...
## Professional Obligations (Seychelles)

### Law Society of Seychelles and Advocates Act

Seychelles lawyers (advocates) are bound by strict confidentiality rules under the Advocates Act (Cap 16) and the Law Society of Seychelles Code of Standards of Professional Practice and Ethical Conduct.
...
3. Client matters: Use commercial legal databases (Seychelles Law Reports, LexisNexis East Africa)
...
2. Follow Seychelles government information security requirements
...
- **Privacy Questions**: Open issue on [GitHub](https://github.com/Ansvar-Systems/seychelles-law-mcp/issues)
- **Anthropic Privacy**: Contact privacy@anthropic.com
- **LSK Guidance**: Consult Law Society of Seychelles ethics guidance
