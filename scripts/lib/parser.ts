/**
 * Seychelles Law PDF Parser
 *
 * Parses text extracted from Seychelles proclamation PDFs (Federal Negarit Gazette).
...
export function parseSeychellesLawHtml(html: string, act: ActIndexEntry): ParsedAct {
  return parsePdfText(html, act);
}
