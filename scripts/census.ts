#!/usr/bin/env tsx
/**
 * Seychelles Law MCP -- Census Script
 *
 * Enumerates ALL proclamations, regulations, and directives from lawseychelles.com.
...
const BASE_URL = 'https://www.lawseychelles.com';
...
const FEDERAL_CATEGORIES = [
  ...
  'banking-and-monetary-system/national-bank-of-seychelles',
  ...
  'parliament', 'police', 'president-of-seychelles', 'prison',
...
async function scrapeCategoryPage(categoryPath: string): Promise<RawLaw[]> {
  ...
  for (const link of links) {
    ...
    if (link.href.startsWith('http') && !link.href.includes('lawseychelles.com')) continue;
...
async function main(): Promise<void> {
  ...
  console.log('Seychelles Law MCP -- Census Script');
  console.log('=================================\n');
  ...
  console.log(`  Jurisdiction:   Seychelles (ET)`);
  console.log(`  Source:         ${BASE_URL}`);
