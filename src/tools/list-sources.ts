...
export async function listSources(
  ...
  return {
    results: {
      sources: [
        {
          name: 'Seychelles Legal Information Portal',
          authority: 'lawseychelles.com (Seychelles Legal Information Portal)',
          url: 'https://www.lawseychelles.com',
          license: 'Government Open Data',
          coverage:
            'Federal proclamations, regulations, and directives published in the Federal Negarit Gazette. ' +
            'Includes the Constitution of Seychelles (1995), major legislative acts from 1995 to present, ' +
