/**
 * Tool registry for Seychelles Law MCP Server.
...
import { getSeychellesImplementations, type GetSeychellesImplementationsInput } from './get-seychelles-implementations.js';
...
const LIST_SOURCES_TOOL: Tool = {
  ...
  description:
    ...
    'including Seychelles Law (National Council for Law Reporting). ' +
    ...
    'Call this FIRST when you need to understand what Seychelles legal data this server covers.',
  inputSchema: { type: 'object', properties: {} },
};
...
export const TOOLS: Tool[] = [
  {
    ...
    description:
      'Search Seychelles statutes and regulations by keyword using full-text search (FTS5 with BM25 ranking). ' +
  ...
  },
  {
    name: 'get_provision',
    description:
      'Retrieve the full text of a specific provision (article) from an Seychelles proclamation or regulation. ' +
  ...
  },
  {
    ...
    description:
      'Validate an Seychelles legal citation against the database — zero-hallucination check. ' +
  ...
  },
  {
    ...
    description:
      'Build a comprehensive set of citations for a legal question by searching across all Seychelles statutes simultaneously. ' +
      'Returns aggregated results from multiple relevant provisions, useful for legal research on a topic. ' +
      'Use this for broad legal questions like "What are the penalties for data breaches in Seychelles?" ' +
  ...
  },
  {
    ...
    description:
      'Format a Seychelles legal citation per standard conventions. ' +
  ...
  },
  {
    name: 'check_currency',
    description:
      'Check whether an Seychelles proclamation or provision is currently in force, amended, or repealed. ' +
  ...
  },
  {
    name: 'get_eu_basis',
    description:
      'Get the EU/international legal basis that a Seychelles statute aligns with or references. ' +
      'Seychelles is not an EU member but several Seychelles laws were influenced by EU regulations ' +
    ...
    inputSchema: {
      type: 'object',
      properties: {
        document_id: { type: 'string', description: 'Seychelles statute identifier.' },
        include_articles: {
          type: 'boolean',
  ...
  {
    name: 'get_seychelles_implementations',
    description:
      'Find all Seychelles statutes that align with or implement a specific EU directive or regulation. ' +
      'Given an EU document ID (e.g., "regulation:2016/679" for GDPR), returns matching Seychelles statutes. ' +
      'Note: Seychelles implements international standards through domestic legislation influenced by international frameworks.',
    inputSchema: {
      type: 'object',
      properties: {
        eu_document_id: {
  ...
  },
  {
    ...
    description:
      'Search for EU directives and regulations that have Seychelles implementing/aligning legislation. ' +
    ...
    inputSchema: {
      ...
      properties: {
        ...
        has_seychelles_implementation: {
          type: 'boolean',
          description: 'If true, only return EU documents with Seychelles aligning legislation.',
        },
  ...
  },
  {
    ...
    description:
      'Get the EU/international legal basis for a SPECIFIC provision within a Seychelles statute. ' +
  ...
  },
  {
    ...
    description:
      'Check EU/international alignment status for a Seychelles statute or provision. ' +
    ...
    try {
      ...
      switch (name) {
        ...
        case 'get_eu_basis':
          ...
          break;
        case 'get_seychelles_implementations':
          result = await getSeychellesImplementations(db, args as unknown as GetSeychellesImplementationsInput);
          break;
